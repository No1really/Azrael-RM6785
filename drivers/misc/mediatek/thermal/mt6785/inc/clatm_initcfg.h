...
#define CLATM_INIT_CFG_0_TARGET_TJ		(86000)
#define CLATM_INIT_CFG_0_EXIT_POINT		(10000)
#define CLATM_INIT_CFG_0_FIRST_STEP		(4160)
...
#define CLATM_INIT_CFG_0_MAX_CPU_PWR		(4160)
#define CLATM_INIT_CFG_0_MIN_GPU_PWR		(200)
#define CLATM_INIT_CFG_0_MAX_GPU_PWR		(2000)

#define CLATM_INIT_CFG_1_TARGET_TJ		(86000)
...
#define CLATM_INIT_CFG_1_MIN_GPU_PWR		(200)
#define CLATM_INIT_CFG_1_MAX_GPU_PWR		(2000)

#define CLATM_INIT_CFG_2_TARGET_TJ		(86000)
...
#define CLATM_INIT_CFG_2_MAX_CPU_PWR		(4160)
#define CLATM_INIT_CFG_2_MIN_GPU_PWR		(200)
