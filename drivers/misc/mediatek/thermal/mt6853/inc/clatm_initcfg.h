...
#define CLATM_INIT_CFG_0_FIRST_STEP		(5000)
...
#define CLATM_INIT_CFG_0_MAX_CPU_PWR		(6000)
#define CLATM_INIT_CFG_0_MIN_GPU_PWR		(500)
#define CLATM_INIT_CFG_0_MAX_GPU_PWR		(1000)
...
#define CLATM_INIT_CFG_1_MIN_CPU_PWR		(500)
#define CLATM_INIT_CFG_1_MAX_CPU_PWR		(5000)
#define CLATM_INIT_CFG_1_MIN_GPU_PWR		(500)
#define CLATM_INIT_CFG_1_MAX_GPU_PWR		(1000)

#define CLATM_INIT_CFG_2_TARGET_TJ		(65000)
#define CLATM_INIT_CFG_2_EXIT_POINT		(10000)
#define CLATM_INIT_CFG_2_FIRST_STEP		(3000)
#define CLATM_INIT_CFG_2_THETA_RISE		(2)
#define CLATM_INIT_CFG_2_THETA_FALL		(8)
#define CLATM_INIT_CFG_2_MIN_BUDGET_CHG		(1)
#define CLATM_INIT_CFG_2_MIN_CPU_PWR		(500)
#define CLATM_INIT_CFG_2_MAX_CPU_PWR		(4000)
#define CLATM_INIT_CFG_2_MIN_GPU_PWR		(500)
#define CLATM_INIT_CFG_2_MAX_GPU_PWR		(1000)
